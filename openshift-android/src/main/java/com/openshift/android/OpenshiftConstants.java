...
/**
 * Contstants for the Openshift Android Application
 * @author Andrew Block
 *
 */
public class OpenshiftConstants {

	public static final String REST_API_VERSION = "1.6";
	
	public static final String APPLICATIONLISTACTIVITY_TAG = "ApplicationListActivityTag";
	
	public static final String DOMAINACTIVITY_TAG = "DomainActivityTag";
